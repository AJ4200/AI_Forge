...
namespace AI_Forge_Service
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="AI_Forge_DB")]
	public partial class AI_ForgeDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteInvoice_Line(Invoice_Line instance);
		...
		public AI_ForgeDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["AI_Forge_DBConnectionString"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public AI_ForgeDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public AI_ForgeDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public AI_ForgeDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public AI_ForgeDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<Address_Book> Address_Books
		{
			get
			{
				return this.GetTable<Address_Book>();
			}
		}
	...
	public partial class User : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<Address_Book> _Address_Books;
    ...
    partial void OnUser_TypeChanged();
		...
		public User()
		{
			this._Address_Books = new EntitySet<Address_Book>(new Action<Address_Book>(this.attach_Address_Books), new Action<Address_Book>(this.detach_Address_Books));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_Address_Book", Storage="_Address_Books", ThisKey="User_Id", OtherKey="User_Id")]
		public EntitySet<Address_Book> Address_Books
		{
			get
			{
				return this._Address_Books;
			}
			set
			{
				this._Address_Books.Assign(value);
			}
		}
		...
		private void attach_Address_Books(Address_Book entity)
		{
			this.SendPropertyChanging();
			entity.User = this;
		}
		
		private void detach_Address_Books(Address_Book entity)
		{
			this.SendPropertyChanging();
			entity.User = null;
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.Address_Book")]
	public partial class Address_Book : INotifyPropertyChanging, INotifyPropertyChanged
	{
		
		private static PropertyChangingEventArgs emptyChangingEventArgs = new PropertyChangingEventArgs(String.Empty);
		
		private int _ADRS_ID;
		
		private int _User_Id;
		
		private string _ADRS_Details;
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnADRS_IDChanging(int value);
    partial void OnADRS_IDChanged();
    partial void OnUser_IdChanging(int value);
    partial void OnUser_IdChanged();
    partial void OnADRS_DetailsChanging(string value);
    partial void OnADRS_DetailsChanged();
    partial void OnActiveChanging(bool value);
    partial void OnActiveChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ADRS_ID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int ADRS_ID
		{
			get
			{
				return this._ADRS_ID;
			}
			set
			{
				if ((this._ADRS_ID != value))
				{
					this.OnADRS_IDChanging(value);
					this.SendPropertyChanging();
					this._ADRS_ID = value;
					this.SendPropertyChanged("ADRS_ID");
					this.OnADRS_IDChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ADRS_Details", DbType="VarChar(100) NOT NULL", CanBeNull=false)]
		public string ADRS_Details
		{
			get
			{
				return this._ADRS_Details;
			}
			set
			{
				if ((this._ADRS_Details != value))
				{
					this.OnADRS_DetailsChanging(value);
					this.SendPropertyChanging();
					this._ADRS_Details = value;
					this.SendPropertyChanged("ADRS_Details");
					this.OnADRS_DetailsChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_Address_Book", Storage="_User", ThisKey="User_Id", OtherKey="User_Id", IsForeignKey=true)]
		public User User
		{
			get
			{
			...
			set
			{
							...
							|| (this._User.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.Address_Books.Remove(this);
					}
					this._User.Entity = value;
					if ((value != null))
					{
						value.Address_Books.Add(this);
    ...
    partial void OnSLE_IDChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_PROD_Category", DbType="VarChar(20) NOT NULL", CanBeNull=false)]
	...
	public partial class Invoice_Line : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private short _InvoiceL_Quantity;
    ...
    partial void OnInvoiceL_QuantityChanging(short value);
    ...
    partial void OnInvoiceL_Price_EachChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_InvoiceL_Quantity", DbType="SmallInt NOT NULL")]
